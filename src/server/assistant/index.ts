...
function systemPrompt(context: {
  ...
  return [
    ...
    '',
    'Daily briefing and metrics:',
    '- When an owner, co-owner or manager asks for a daily briefing, what needs attention, or how the company is doing, use daily_briefing. Give the actual priorities and highlights back in a compact answer.',
    '- For detailed performance or workload questions, use company_metrics. Workers are not allowed to receive management metrics.',
    '',
